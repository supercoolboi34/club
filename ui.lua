...
function Library:MakeResizable(Instance, MinSize)
    ...
    ResizeHandle.InputBegan:Connect(function(Input)
        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) and Resizing do
...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        Library:AddToRegistry(ModeLabel, {
            TextColor3 = 'AccentColor';
        });
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        function Dropdown:BuildDropdownList()
            ...
            for Idx, Value in next, Values do
                ...
                -- Enhanced Multi-dropdown UI with checkbox
                if Info.Multi then
                    ...
                    function Table:UpdateButton()
                        ...
                        CheckboxInner.BackgroundColor3 = Selected and Library.AccentColor or Library.BackgroundColor;
                        Library.RegistryMap[CheckboxInner].Properties.BackgroundColor3 = Selected and 'AccentColor' or 'BackgroundColor';
